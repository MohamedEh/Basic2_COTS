...
uint8 DIO_u8TogglePinValue(DIO_Port_t copy_Port, DIO_Pin_t copy_PinNum){
	...
	if ((copy_PinNum>=DIO_PIN0) &&	(copy_PinNum <= DIO_PIN7)){
		...
		case DIO_PORTA:	 TOGGLE_BIT(PINA, copy_PinNum); break;
		case DIO_PORTB:	 TOGGLE_BIT(PINB, copy_PinNum); break;
		case DIO_PORTC:	 TOGGLE_BIT(PINC, copy_PinNum); break;
		case DIO_PORTD:	 TOGGLE_BIT(PIND, copy_PinNum); break;
		default : Local_u8ErrorState = NOK; break;
